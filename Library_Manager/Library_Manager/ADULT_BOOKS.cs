...
{
    class ADULT_BOOKS:Media,ISerializable
    {
        //property
        ...
        public ADULT_BOOKS(uint id, string na, DateTime date)
        {
            MediaName= na;
            MediaID = id;
            CheckOutDate = date;
        ...
        public ADULT_BOOKS(uint id, string na, DateTime date, MediaType media)
        {
            MediaName = na;
            MediaID = id;
            CheckOutDate = date;
        ...
        public ADULT_BOOKS(string id, string na, int st)
        {
            MediaName = na;
            MediaID1 = id;
            Status = st;
        ...
        public ADULT_BOOKS(SerializationInfo info, StreamingContext ctxt)
        {
